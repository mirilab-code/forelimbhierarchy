...
%
function GrangerRes = runGranger_G_ETM_only_half1(SpikeTrains, globalRegressor_In, historyRegressor, historyRegressorNBins,pairs_used)
...
neuronsHalf1 = 1:ceil(nNeurons/2);
