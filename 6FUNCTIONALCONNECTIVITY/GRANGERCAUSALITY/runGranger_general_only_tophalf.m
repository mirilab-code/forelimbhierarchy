...
OutStruct = runGranger_G_ETM_only_parneur_tophalf(SpikeTrains, globalRegressor, historyRegressor, historyRegressorNBins,pairs_used);

% now save all the results
cd('C://Users/mirilab/Documents/Adam/reaching/10k_granger_trains/04012020')
fName = ['./04012020_Out_fixed_only_tophalf.mat'];
fprintf('Saving %s \n', fName);
save(fName);
%%
