...
dates_run = ['04012020';'04022020';'10052020';'10062020'];
all_pvals_R2C = [];
all_pvals_C2R = [];
all_D_R2C = [];
all_D_C2R = [];
...
str1 = sprintf('C:/Users/mirilab/Documents/Adam/reaching/10k_granger_trains/%s/%s_Out_fixed_only.mat',...
    date,date)
%str1 = sprintf('Z:/Granger/G_ETM/%s/Out.mat',date);
load(str1);
...
for ii = 1:size(CFA_RFA_pairs,1)
    ...
    if Psi2_old(CFA,RFA)==1
        Psi3(CFA,RFA)=1;
    end
    if Psi2_old(RFA,CFA)==1
        Psi3(RFA,CFA)=1;
    end
end
...
%%
all_D_both = [all_D_R2C,all_D_C2R];
figure;
