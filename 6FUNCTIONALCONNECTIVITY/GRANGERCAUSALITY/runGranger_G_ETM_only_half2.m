...
%
function GrangerRes = runGranger_G_ETM_only_half2(SpikeTrains, globalRegressor_In, historyRegressor, historyRegressorNBins,pairs_used)
...
neuronsHalf1 = ceil(nNeurons/2)+1:nNeurons;
for currGlobalRegressorInd = 1:nglobalRegressorNBins
	...
	for currHistoryRegressorInd = 1:nhistoryRegressorNBins
		...
		parfor currNeuronInd = 1:nNeurons
            if ismember(currNeuronInd,neuronsHalf1)
