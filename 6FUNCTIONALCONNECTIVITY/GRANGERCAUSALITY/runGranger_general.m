...
D = load('C://Users/mirilab/OneDrive - Northwestern University/Documents/Adam/reaching/10k_granger_trains/10282020/10282020_granger_train_pre.mat');
C = load('C://Users/mirilab/OneDrive - Northwestern University/Documents/Adam/reaching/10k_granger_trains/10282020/10282020_final_list.mat')
...
globalRegressor.nBins = [1, 5, 10, 20, 25];
...
OutStruct = runGranger_G_ETM_only_parneur(SpikeTrains, globalRegressor, historyRegressor, historyRegressorNBins,pairs_used);

% now save all the results
cd('C://Users/mirilab/OneDrive - Northwestern University/Documents/Adam/reaching/10k_granger_trains/10282020')
fName = ['./10282020_Out_fixed_only_parneur_pre.mat'];
fprintf('Saving %s \n', fName);
save(fName);
%%
