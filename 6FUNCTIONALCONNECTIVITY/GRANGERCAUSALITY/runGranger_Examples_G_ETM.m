...
switch dataSet
    ...
    case 3
        D = load('C:/Users/mirilab/Documents/Adam/reaching/granger_trains/09222020/granger_train_long_spout.mat');
        %SpikeTrains = D.high_FR_granger([7,18,24,40,43,56],750:1050,:);
        %SpikeTrains = D.high_FR_granger(1:6,750:1050,:);
        SpikeTrains = D.granger_train([12,28,35,68,73,97],:,:);
        SpikeTrains(:,end,:) = [];
        sample_Hz = 1000;
        sampleTime_ms = 1000 / sample_Hz;
end
