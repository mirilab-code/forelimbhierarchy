...
dates_run = ['03312020';'04012020';'04022020';'09222020';'09232020';...
    '09302020';'10012020';'10022020';'10052020';...
    '10062020';'10242020';'10272020';'10282020';'11172020'];
dates_run = ['04022020'];
...
for session_num = 1:size(dates_run,1)
    ...
    str = sprintf('C:/Users/mirilab/Documents/Adam/reaching/10k_granger_trains/%s/%s_num_neurons.mat',...
        date,date);
    load(str);
    str = sprintf('C:/Users/mirilab/Documents/Adam/reaching/10k_granger_trains/%s/%s_final_list.mat',...
        date,date);
    load(str);
    ...
    str1 = sprintf('C:/Users/mirilab/Documents/Adam/reaching/10k_granger_trains/%s/%s_Out_fixed_only_half1.mat',...
        date,date);
    load(str1);
    Psi1half1 = OutStruct.Psi1;
    Dhalf1 = OutStruct.glm_dev_ratio;
    
    str1 = sprintf('C:/Users/mirilab/Documents/Adam/reaching/10k_granger_trains/%s/%s_Out_fixed_only_half2.mat',...
        date,date);
    load(str1);
    Psi1half2 = OutStruct.Psi1;
    Dhalf2 = OutStruct.glm_dev_ratio;
    
    Psi1_old = zeros(nNeurons,nNeurons);
    D = zeros(nNeurons,nNeurons);
    Psi1_old(1:ceil(nNeurons/2),:) = Psi1half1(1:ceil(nNeurons/2),:);
    Psi1_old(ceil(nNeurons/2)+1:nNeurons,:) = Psi1half2(ceil(nNeurons/2)+1:nNeurons,:);
    P = zeros(nNeurons,nNeurons);
    D(1:ceil(nNeurons/2),:) = D(1:ceil(nNeurons/2),:);
    D(ceil(nNeurons/2)+1:nNeurons,:) = D(ceil(nNeurons/2)+1:nNeurons,:)
