...
OutStruct = runGranger_G_ETM_only_half2(SpikeTrains, globalRegressor, historyRegressor, historyRegressorNBins,pairs_used);

% now save all the results
cd('C://Users/mirilab/Documents/Adam/reaching/10k_granger_trains/04022020')
fName = ['./04022020_Out_fixed_only_half2.mat'];
fprintf('Saving %s \n', fName);
save(fName);
%%
