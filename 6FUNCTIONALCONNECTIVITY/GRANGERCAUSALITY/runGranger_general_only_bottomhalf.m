...
D = load('C://Users/mirilab/Documents/Adam/reaching/10k_granger_trains/04012020/04012020_granger_train.mat');
C = load('C://Users/mirilab/Documents/Adam/reaching/10k_granger_trains/04012020/04012020_final_list.mat')
E = load('C://Users/mirilab/Documents/Adam/reaching/10k_granger_trains/04012020/04012020_Out_fixed_only_tophalf.mat')
OutStructTop = E.OutStruct;
...
OutStruct = runGranger_G_ETM_only_parneur_bottomhalf(OutStructTop, SpikeTrains, globalRegressor, historyRegressor, historyRegressorNBins,pairs_used);

% now save all the results
cd('C://Users/mirilab/Documents/Adam/reaching/10k_granger_trains/04012020')
fName = ['./04012020_Out_fixed_only_bottomhalf.mat'];
fprintf('Saving %s \n', fName);
save(fName);
%%
