...
for i = 2:6 % Num  ber of across-area latents
    for x = 4 %[2,3,5,6] % Number of within-area latents per area
    ...
    cd(session_path)
    save(sprintf('%s_new_run%g_dim%g_dlag_model.mat', work, runIdx, i))
    end
end
...
xDim_within = [xDims_within{1}, xDims_within{2}];
...
save(sprintf('%s_new_run%g_dim%g_workspace.mat', work, runIdx, i))
