function [spkvec,spike_count,timevec,updatedpeak] = smooth_spikes_NK(timestamps,binsize,min_timevec,max_timevec,sigma,peak)
...
timevec = min_timevec : binsize : max_timevec;
spike_count = histc( timestamps, timevec ); % bin size is 1/srate

%gaussian kernel (mean=0; sigma from input)
gk_mu    = 0;      
gk_sigma = sigma;
gk_x = -10*sigma+ binsize : binsize : +10*sigma;
