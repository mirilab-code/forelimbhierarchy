...
train_params['performance_cutoff'] = -0.02      # this is dumb because it only lets you terminate when the performance is OVER a certain value but we just want to measure
